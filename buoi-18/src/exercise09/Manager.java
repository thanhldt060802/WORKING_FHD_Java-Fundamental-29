...
public class Manager extends Employee {
    ...
    public Employee copy() {
        return new Manager(super.getId(), super.getName(), super.getHourOfTimeserving(), super.getSalaryPerHourOfTimeserving(),
            super.getHourOfOvertime(), super.getBonusSalaryPerHourOfOvertime(), this.bonusRate, this.kpiPoint, this.kpiThreshold);
    }
