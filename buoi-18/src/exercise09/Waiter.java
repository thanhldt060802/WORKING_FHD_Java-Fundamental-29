...
public class Waiter extends Employee {
    ...
    public Employee copy() {
        return new Waiter(super.getId(), super.getName(), super.getHourOfTimeserving(), super.getSalaryPerHourOfTimeserving(),
            super.getHourOfOvertime(), super.getBonusSalaryPerHourOfOvertime(), this.rating, this.bonusSalary);
    }

    @Override
    public String toString() {
        return "Waiter [id=" + super.getId() + ", name=" + super.getName() + ", hourOfTimeserving=" + super.getHourOfTimeserving()
