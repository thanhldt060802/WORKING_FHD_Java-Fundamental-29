...
public class Main {
    ...
    public static void main(String[] args) {
		...
		// Chef chef = (Chef)res.searchEmployeeById("E03");
		// chef.setName("X");
		...
		// Chef chef = new Chef("E10", "Z", 120, 17.0, 30, 9.5, 5, 0.15);
		// res.updateEmployee(chef);
		...
		res.addEmployee(new Employee("E08", "A", 80, 12.5, 17, 5.9));
		res.addEmployee(new Employee("E03", "B", 100, 12.5, 20, 5.9));
		res.addEmployee(new Chef("E05", "C", 110, 15, 25, 7, 3, 0.09));
		res.addEmployee(new Chef("E04", "D", 120, 16, 30, 7.5, 5, 0.09));
		res.addEmployee(new Chef("E07", "E", 115, 15, 15, 7.2, 2, 0.09));
		res.addEmployee(new Waiter("E06", "F", 85, 13, 24, 6.5, 3.5, 200));
		res.addEmployee(new Waiter("E09", "G", 97, 13, 20, 6.5, 4.5, 200));
		res.addEmployee(new Waiter("E02", "H", 95, 14, 31, 6.5, 4, 200));
		res.addEmployee(new Manager("E10", "J", 130, 18.5, 34, 8.6, 0.55, 7.8, 10));
		res.addEmployee(new Manager("E01", "K", 145, 18, 22, 8.3, 0.45, 8.1, 8.5));
		System.out.println("Restaurant after adding 10 employees:");
		res.showAllEmployees();

		// System.out.println();

		// ArrayList<Employee> employeeList1 = res.searchEmployeeWithRoleByChef();
		...
		// ArrayList<Employee> employeeList2 = res.searchEmployeeWithRoleByWaiter();
		...
		// ArrayList<Employee> employeeList3 = res.searchEmployeeWithRoleByManager();
		// System.out.println("List of managers:");
		// for(Employee emp : employeeList3) {
		// 	System.out.println(emp);
		// }
		...
		// System.out.println("Employee list after sorting by hour of timeserving ascending:");
		// res.showAllEmployees();

		// System.out.println();

		// res.sortByActualSalaryAscending();
		// System.out.println("Employee list after sorting by actual salary ascending:");
		// res.showAllEmployees();

		System.out.println();

		res.sortByIdAscending();
		System.out.println("Employee list after sorting by id ascending:");
		res.showAllEmployees();
